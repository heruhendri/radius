...
func GetCompany(c *gin.Context) {
	...
	if result.Error != nil {
		// Return defaults when no company record exists yet (same as Next.js behavior)
...
func UpdateCompany(c *gin.Context) {
	...
	if req.AdminPhone != nil {
		updates["adminPhone"] = *req.AdminPhone
	}
	if req.BaseURL != nil {
	...
	if req.PoweredBy != nil {
		updates["poweredBy"] = *req.PoweredBy
	}
	if req.CustomerIDPrefix != nil {
		updates["customerIdPrefix"] = *req.CustomerIDPrefix
	}
	if req.InvoiceGenerateDays != nil {
		updates["invoiceGenerateDays"] = *req.InvoiceGenerateDays
	}
	if req.GracePeriodDays != nil {
		updates["gracePeriodDays"] = *req.GracePeriodDays
	}
	if req.IsolationEnabled != nil {
		updates["isolationEnabled"] = *req.IsolationEnabled
	}
	if req.IsolationIPPool != nil {
		updates["isolationIpPool"] = *req.IsolationIPPool
	}
	if req.IsolationRateLimit != nil {
		updates["isolationRateLimit"] = *req.IsolationRateLimit
	}
