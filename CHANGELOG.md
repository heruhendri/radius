...
```bash
# Fresh install test
cd /root/AIBILL-RADIUS-main/vps-install
...
Comprehensive uninstaller untuk remove semua komponen AIBILL RADIUS dan enable fresh install.
...
- ✅ **Backup Location**: `/root/aibill-backup-TIMESTAMP/`
...
8. ✅ All logs (/var/log/aibill-vps-install.log, etc.)
...
- ✅ Logging to `/var/log/aibill-vps-install.log`
...
```bash
# Check error
tail -f /var/log/aibill-vps-install.log | grep "mysql"
...
**LOGS:**
- `/var/log/aibill-vps-install.log` - Installation log dengan timestamps
...
Logs: `/var/log/aibill-vpn-install.log`
...
- ✅ **Features:**
  ...
  - Config directory: `/etc/aibill-vpn/`
  - Logs: `/var/log/aibill-vpn-install.log`
...
- ✅ AIBILL RADIUS integration steps
...
- Location: `C:\Users\yanz\Downloads\AIBILL-RADIUS-FRESH-INSTALL`
