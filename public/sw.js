const CACHE_NAME = 'salfanet-customer-pwa-v1';
const OFFLINE_URL = '/customer/offline';
const STATIC_ASSETS = [
  OFFLINE_URL,
  '/manifest.json',
  '/pwa/icon-192.svg',
...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <p>Portal pelanggan tidak bisa mengambil data terbaru sekarang.</p>
      <p>Sambungkan kembali internet lalu buka ulang dashboard atau cek tagihan dari cache jika masih tersedia.</p>
      <a href="/customer">Coba lagi</a>
    </main>
  </body>
</html>`,
    {
  ...
  if (request.mode === 'navigate') {
    event.respondWith((async () => {
      try {
        ...
        return offlinePage || offlineFallbackResponse();
      }
    })());
    return;
  }
